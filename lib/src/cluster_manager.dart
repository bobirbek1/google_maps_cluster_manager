...
class ClusterManager<T extends local.ClusterItem> {
  ...
  /// Add on cluster item
  void addItem(local.ClusterItem newItem) {
  ...
  static Future<Marker> Function(local.Cluster) get _basicMarkerBuilder =>
      (cluster) async {
        return Marker(
